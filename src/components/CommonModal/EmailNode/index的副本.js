...
class ConditionElement extends Component {
  ...
  componentWillMount() {
    this.setState({
      editorState: BraftEditor.createEditorState(this.props.EmailContent?this.props.EmailContent.EmailDetail?this.props.EmailContent.EmailDetail:null:null),
      shieldDay: this.props.EmailContent?this.props.EmailContent.ShieldDay?this.props.EmailContent.ShieldDay:undefined:undefined,
      isShieldDays: this.props.EmailContent?this.props.EmailContent.IsShieldDays?this.props.EmailContent.IsShieldDays:false:false,
      IsShieldBlack: this.props.EmailContent?this.props.EmailContent.IsShieldBlack?this.props.EmailContent.IsShieldBlack:false:false,
      title:this.props.EmailContent?this.props.EmailContent.Title?this.props.EmailContent.Title:"":"",
      nodeName:this.props.EmailContent?this.props.EmailContent.NodeName?this.props.EmailContent.NodeName:"":""
    })
  }
  ...
  testHandle=e=>{
    ...
    let fromData = {
      ...
      let requestData={
        ...
        EmailDetail:fromData.EmailDetail.toHTML()
      };
      ...
      <Form {...formItemlayout} className={styles.EmailNode}>
        ...
        <Form.Item label='邮件测试'>
          <Row type='flex' gutter={8}>
            ...
            <Col><Button type='primary' onClick={this.testHandle} className={styles.btn}>邮件测试</Button></Col>
            <Col><a onClick={() => { this.recordOverlay.show() }}>邮件测试记录</a></Col>
            <Col span={1}></Col>
          </Row>
        </Form.Item>
        <FormItem label="屏蔽设置">
        ...
        <RecordOverlay ref={(ref) => { this.recordOverlay = ref }} />
      </Form>
    )
  }
}
...
class EmailNode extends Component {
  ...
  render() {
    return (
      ...
      >
        <EmailForm IsCanvas={this.props.IsCanvas} EmailContent={this.props.EmailContent} wrappedComponentRef={ref => this.emailForm = ref} />
      </DMOverLay>
    )
  }
}
