...
class SelectChannelNew extends Component {
  static defaultProps = {
    data: [],
  }
              ...
              >
                {
                 this.state.channel.child!=null?this.state.channel.child.map((item, key) => {
                    return (
                      <Select.Option key={key} value={item.platform}>
                        <Tooltip placement="topLeft" title={item.platformname}>
                          {item.platformname}
                        </Tooltip>
                      </Select.Option>
                    )
...
export default SelectChannelNew;
